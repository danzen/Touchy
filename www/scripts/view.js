...
var app = function(app) {
    ...
    app.makeView = function(layoutManager) {
        ...
        var wiggleSet = true;
        timeout(wiggleBatchTime, v.blobWiggle);
        ...
        v.scale = function (page) {
            ...
            if (page == page1) {
                ...
                if (!wiggleSet) {
                    wiggleSet = true;
                    timeout(wiggleBatchTime, v.blobWiggle2);
                }
                ...
                if (!wiggleSet) {
                    wiggleSet = true;
                    timeout(wiggleBatchTime, v.blobWiggle3);
                }
            }
        ...
        var play = page1.play = new Button({
            color:frame.pink,
            label:new Label({
                text:"PLAY",
                color:"white"
        ...
        var tagline = page1.tagline = new Label({
        ...
        var page2 = v.page2 = new Container(600, 800);
        ...
        var next = page2.next = new Button({
            label:"NEXT",
            color:frame.pink,
            corner:0
        }).addTo(page2);
        ...
        var header = page4.header = new Container(600, 100)
            .addTo(page4);
        ...
        var score = page4.score = new Label({
            text:"100",
            color:"white",
            size:50,
            backing:new Rectangle(130, 100, "rgba(0,0,0,.2)")
        }).addTo(header).pos(header.width-130);


        var circles = new Container()
            .addTo(page4);
        var outer = page4.outer = new Circle(stageW*.95/2, frame.green, "rgba(0,0,0,.2)", 1, false)
            .addTo(circles).expand(600);
        var inner = page4.inner = new Circle(stageW*.5/2, frame.yellow, "rgba(0,0,0,.2)", 1, false)
            .addTo(circles);

        var footer = v.page4.footer = new Container(600, 100)
            .addTo(page4);
        var time = page4.time = new Label({
            text:"0:20",
            color:"white",
            size:75
        }).center(footer);
        ...
        var details = new Container(500,420).addTo(page5);

        // new Guide(details, false);
        var heightAdjust = 68;
        ...
        var score2 = page5.score = new Label({
            text:"100",
            color:"white",
            size:50,
            backing:new Rectangle(130, 100, "rgba(0,0,0,.3)")
        ...
        var stats = new Container(500,420).addTo(page6);

        var label3 = page6.message = new Label({
        ...
        var margin = 6;
        var chart = new Container(300, 200).center(stats);
        chart.addChild(new Rectangle(chart.width,chart.height,"black").alp(.2));
        var wins = new Label({
            text:"LOSSES",
            color:"white",
            align:"right",
            size:25,
            backing:new Rectangle(chart.width*.55,(chart.height-margin*4)/3).alp(.8)
        }).addTo(chart).pos(margin, margin);
        wins.text = "WINS";

        var winsAmount = page6.winsAmount = new Label({
            text:"2",
            color:"white",
            align:"center",
            size:25,
            backing:new Rectangle(chart.width*.45-margin*3,wins.height,null,"#333",1)
        ...
        var again = page6.again = new Button({
            color:frame.pink,
            label:new Label({
                text:"PLAY",
                color:"white"
        ...
        var clear = page6.clear = new Button({
            width:90,
            height:40,
            label:new Label({text:"CLEAR", size:20, color:"white", align:"center"}),
            color:"rgba(0,0,0,.3)",
